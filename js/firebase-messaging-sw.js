...
self.addEventListener('push', function (event) {
    ...
    var parsedData = event.data.json();
    var notification = parsedData.notification;
    var title = notification.title;
    var body = notification.body;
    var icon = notification.icon;
    var data = parsedData.data;

    event.waitUntil(self.registration.showNotification(title, { body: body, icon: icon, data: data }));
}, false);
